...
| Image upload returns `401 INVALID_UPLOAD_TOKEN` | The token was already used, or more than 15 minutes elapsed since `createArticleImageUpload`. Tokens are single-use — mint a fresh one per image. |
